...
class Contact extends Component {
    ...
    handleBlur = (field) => (evt) => {
        debugger;
        console.log("Current State is : " + field + evt);
        this.setState({
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.telnum && !reg.test(telnum))
            errors.telnum = 'Tel. numeber should contain only numbers.'
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={{size: 3, offset: 1}}>
                                    <Input type="select" id="contacType" name="contactType" placeholder="Select type" value={this.state.contactType} onChange={this.handleInputChange}>
                                        <option>Tel.</option>    
                                        <option>Email</option>  
                                    </Input>
                                </Col>
